...
if __name__ == '__main__':
    ...
    df_results_bilstmcrf = pd.read_csv("data/results/bilstmcrf/bilstmcrf_results_post_processed.csv")
    df_results_biobertpt = pd.read_csv("data/results/biobertpt/biobertpt_results_post_processed.csv")
    df_results_gemini1_5 = pd.read_csv("data/results/gemini1.5/results_prompt_3_two_ex_structured_post_processing_test.csv")
    df_results_gpt4 = pd.read_csv("data/results/gpt4-o/results_prompt_2_two_ex_structured_post_processing_test.csv")
    df_results_llama3 = pd.read_csv("data/results/llama3/results_prompt_3_one_ex_structured_post_processing_test.csv")


    df_structured_data = pd.read_excel('data/structured_data_for_lung_rads.ods')
    ...
    df_results_bilstmcrf.to_csv('data/lung_rads_predictions_bilstmcrf.csv', index=False)
    df_results_biobertpt.to_csv('data/lung_rads_predictions_biobertpt.csv', index=False)
    df_results_gemini1_5.to_csv('data/lung_rads_predictions_gemini1_5.csv', index=False)
    df_results_gpt4.to_csv('data/lung_rads_predictions_gpt4o.csv', index=False)
    df_results_llama3.to_csv('data/lung_rads_predictions_llama3.csv', index=False)
