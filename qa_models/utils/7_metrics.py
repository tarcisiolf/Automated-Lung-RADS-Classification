...
if __name__=='__main__':
    ...
    ("Tamanho do nódulo", "Tamanho do nódulo (mm)")
]

    df_test = pd.read_csv("data/one_lung_nodule/few_shot/test_post_processing_v2.csv")
    ...
    # Few shot
    df_result = pd.read_csv("data/one_lung_nodule/few_shot/results_gemini/results_prompt_3_two_ex_structured_post_processing_v2.csv")
    csv_filename = "data/one_lung_nodule/few_shot/results_gemini/metrics_prompt_3_two_ex_structured_v2.csv"
